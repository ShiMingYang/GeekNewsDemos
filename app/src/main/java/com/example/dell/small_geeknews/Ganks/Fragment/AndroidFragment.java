...
public class AndroidFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = LayoutInflater.from(getContext()).inflate(R.layout.android, null);
        initView(inflate);
        initData();
        return inflate;
    }
    ...
    private void initData() {
        ...
        Observable<AndroidBean> androiddata = mySerVer.androiddata();
    ...
    private void initView(View inflate) {
        ...
        Glide.with(getContext()).load(R.drawable.meizi1).apply(options).into(mIvTechBlur);
        Glide.with(getContext()).load(R.drawable.meizi1).into(mIvTechOrigin);
