...
public class IOSAdapter extends RecyclerView.Adapter{
    ...
    private ArrayList<IosBean.ResultsBean> mlist;

    public IOSAdapter(FragmentActivity activity, ArrayList<IosBean.ResultsBean> list) {
    ...
    public void setList(IosBean iosBean) {
      mlist.addAll(iosBean.getResults());
